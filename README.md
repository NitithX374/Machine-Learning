...
| **Gradient Descent** | ลูกบอลไถลลง loss surface — ปรับ lr ดูลู่เข้า/แกว่ง/กระเด็นหลุด + local minimum |
...
| **RL Gridworld** | Q-learning สด — ดู agent เรียนหาทางไปเป้า, policy arrows + value heatmap ก่อตัว |
| **Overfitting Explorer** | ลาก slider เปลี่ยน degree — เห็น train error ลดแต่ test error พุ่ง (overfit) |
